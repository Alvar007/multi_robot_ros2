...
#[link(name = "t3_action_msg__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__t3_action_msg__action__Move() -> *const std::ffi::c_void;
}

// Corresponds to t3_action_msg__action__Move
#[allow(missing_docs, non_camel_case_types)]
pub struct Move;
...
impl rosidl_runtime_rs::Action for Move {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__t3_action_msg__action__Move() }
  }
